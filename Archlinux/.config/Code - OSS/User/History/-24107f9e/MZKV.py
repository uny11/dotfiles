...
#DATABASE_URL = 'https://api.meteo.cat/xema/v1/representatives/metadades/municipis/082877/variables/32' # URL de la API
DATABASE_URL = 'https://api.meteo.cat/xema/v1/estacions/WP/metadades'
